...
python3 -c "from _log_extractor import run; run('091101', hh='05', taxi_id=14964)" &
python3 -c "from _log_extractor import run; run('091101', hh='06', taxi_id=14964)" &
python3 -c "from _log_extractor import run; run('091101', hh='07', taxi_id=14964)" &
